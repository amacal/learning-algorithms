...
from learning_algorithms.network_similator import MixedNetworkTrafficGenerator
...
class MixedNetworkBenchmark:
    ...
    def execute(self, target: BenchmarkTarget) -> None:
        ...
        estimator = target.get_estimator()
        generator = MixedNetworkTrafficGenerator(servers=servers, clients=clients)
